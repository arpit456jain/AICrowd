...
import './Home.css';
import SideNavigationClone from './SideNavigationClone';
...
function HomeClone() {
  ...
  return (
    <div className="app-container">
      <Router>
        <SideNavigationClone userEmail={user_email} onLogout={handleLogout} totalPoints={totalPoints} FetchPoints={FetchPoints}/>
